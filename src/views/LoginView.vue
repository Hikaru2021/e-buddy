        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
            <div
                ...
                <div class="absolute inset-0">
                    <img class="object-cover object-top w-full h-full"
                        src="https://cdn.rareblocks.xyz/collection/celebration/images/signin/4/girl-thinking.jpg" alt="" />
                </div>
            ...
            <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                    <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl">Sign in to E-Buddy</h2>
                    <p class="mt-2 text-base text-gray-600">Don’t have an account? <a href="#" title=""
                            ...
                            @click="redirectToRegister">Create
                            a free account</a></p>
                    ...
                    <form action="#" method="POST" class="mt-8">
                        <div class="space-y-5">
                            ...
                            <div>
                                <button type="submit" @click="redirectToLogin"

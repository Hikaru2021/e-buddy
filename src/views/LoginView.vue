<template>
    <section>
        <div>
            <div class="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8 bg-image">
                <div class="flex items-center justify-center p-10 px-4 py-10 sm:px-6 lg:px-8 sm:py-16 lg:py-24 rounded-3xl bg-white shadow-lg">
                        ...
                        <form action="#" method="POST" class="mt-8">
                            <div class="space-y-5">
                                ...
                                <div>
                                    <button
                                        type="submit"
                                        class="inline-flex items-center justify-center w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md bg-gradient-to-r from-orange-600 to-orange-100 focus:outline-none hover:opacity-80 focus:opacity-80"
